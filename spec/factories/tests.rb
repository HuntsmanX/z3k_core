...
FactoryGirl.define do
  ...
  factory :test_with_sections do |f|
  ...
  factory :section, class: Forms::Test::Section do |f|
    ...
    factory :section_with_questions do |f|
      after(:create) do |section|
        create(:question_with_fields, section: section)
    end
  end
end
  ...
  factory :question, class: Forms::Test::Question do |f|
    ...
    f.order_index { 0 }
    factory :question_with_fields do |f|
  ...
  factory :field, class: Forms::Test::Field do |f|
    ...
    factory :field_with_options do |f|
